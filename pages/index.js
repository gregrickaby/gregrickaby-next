...
const Index = () => (
  <Layout>
    ...
    <p>
      ...
      problems for clients like Microsoft, Viacom, News Corporation, Campbell’s
      Soup Company, and the NBA.
    </p>
    <p>
      Over the years,{' '}
      <strong>
    ...
    <p>
      ...
      <a href="https://gregslink.co/create-a-website-am">Amazon</a> ), and{' '}
    ...
    <p>
      ...
      <strong>I enjoy being a dad and hanging out with family</strong> , as well
      as serving my community through{' '}
      <a href="https://wiregrasschurch.org">Wiregrass Church</a> . I’ve also
