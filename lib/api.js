 ...
 * @param  {contentBlocks} array  The array you need to convert to an object.
 * @param  {keyField}      string The ID of the new object.
 * @return {object}               An object with IDs.
 */
export function arrayToObject(contentBlocks, keyField) {
  return contentBlocks.reduce((obj, item) => {
